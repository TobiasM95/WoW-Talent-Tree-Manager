...
//#endif
    ...
    IMGUI_API bool          TabItemExNoClose(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags, ImGuiWindow* docked_window);
    ...
    IMGUI_API int           PlotHistogramRedGreenEx(const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, char** values_labels, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 frame_size);
